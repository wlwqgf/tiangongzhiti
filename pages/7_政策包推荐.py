...
st.info("输入企业资质标签，系统横向拉通梯度培育 / 专精特新 / 数字化车间 / 工业设计中心 / 单项冠军 / "
        ...
        "东北区域省级奖补（辽·吉·黑）等政策，自动按「互斥组取高、叠加上限」算出最优不冲突组合与资金总额。"
        "首台套、东北振兴金融工具等已接入东北三省真实奖补口径；选择申报省份后可叠加对应省级奖补。")
...
if submit_pk:
    ...
    st.caption("⚠️ [真实·大连]为惠企30条明确值；[真实·东北]为东北三省省级政策明文值；[真实·全国]为国家级政策；"

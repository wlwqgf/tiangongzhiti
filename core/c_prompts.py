...
# B. 申报材料类（6份）
APPLICATION_DOCS = [
    {"id": "B1", "name": "大连华锐重工集团股份有限公司-辽宁省-装备制造-卓越级智能工厂项目申报书（盖章件）.pdf", "format": "PDF", "level": "卓越级", "usage": "申报书模板范本"},
    {"id": "B2", "name": "大连华锐重工电控装备厂_先进级智能工厂项目申报书.pdf", "format": "PDF", "level": "先进级", "usage": "申报书模板范本"},
    {"id": "B3", "name": "1.先进级智能工厂项目申报书-大连中集特种物流装备有限公司.pdf", "format": "PDF", "level": "先进级", "usage": "申报书模板范本"},
...
- 申报范本 6 份：华锐重工（卓越级+先进级）、中集特种物流（先进级）真实盖章件
...
- 风格：正式公文 + 行业术语，对标华锐重工和中集特种物流的盖章件
- 语气：客观、严谨、可信

...
POLICIES = [
    ...
    # —— 内蒙古：占位条目（自治区级奖补细则暂缺，避免空选项误导） ——
    {"key": "nmg_smart_factory", "name": "内蒙古·智能工厂/数字化车间奖补", "level": "内蒙古自治区", "group": None,
     "region": "内蒙古", "eligible": lambda p: "内蒙古" in (p.get("region") or []), "amount": lambda p: 0, "status": "pending",
     "basis": "内蒙古自治区智能工厂/数字化车间/绿色工厂等梯度奖补细则暂缺；中央层面'东北振兴金融工具'（财金〔2026〕2号）覆盖内蒙古，"
              "中央财政对设备更新贷款贴息1.5个百分点、≤2年；具体自治区级奖补金额以最新自治区工信厅申报通知为准。",
     "note": "[暂无·占位]"},
]
